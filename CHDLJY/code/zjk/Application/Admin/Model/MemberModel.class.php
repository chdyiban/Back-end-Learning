...
class MemberModel extends Model {
    ...
    protected $_validate = array(
        array('name','nicknameLength', '', '', 'callback'),
        array('name', '', '昵称被占用', self::EXISTS_VALIDATE, 'unique'), //用户名被占用
    );
    ...
    public function nicknameLength($name)
    {
        if(mb_strlen($name,'utf-8')<modC('NICKNAME_MIN_LENGTH',2,'USERCONFIG')||mb_strlen($name,'utf-8')<modC('NICKNAME_MAX_LENGTH',32,'USERCONFIG')){
