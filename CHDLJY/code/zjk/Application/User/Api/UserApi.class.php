...
class UserApi extends Api{
     ...
     */
    public function register($username,$name, $password, $email, $mobile = ''){
        return $this->model->register($username,$name, $password, $email, $mobile);
    }
    ...
    public function login($username, $password, $type = 1){
        ...
        if(file_exists('./api/uc_login.lock')){
            ...
            elseif($uc_user[0]>0){
                ...
                D('member')->where(array('uid'=>$uc_user[0]))->setField('name',$uc_user[1]);
