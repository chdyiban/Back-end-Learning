...
class SystemController extends BaseController
{
    ...
    {
        //调用API获取基本信息
        $user = query_user(array('name', 'email', 'mobile', 'last_login_time', 'last_login_ip', 'score', 'reg_time', 'title', 'avatar256','rank_link'), $uid);
        //显示页面
    ...
    public function fans($page = 1)
    {
        ...
        $fans = D('Follow')->getFans(is_login(), $page, array('avatar128', 'id', 'name', 'fans', 'following', 'weibocount', 'space_url','title'),$totalCount);
    ...
    {
        $following = D('Follow')->getFollowing(is_login(), $page, array('avatar128', 'id', 'name', 'fans', 'following', 'weibocount', 'space_url','title'),$totalCount);
