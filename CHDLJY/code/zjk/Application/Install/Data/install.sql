...
CREATE TABLE IF NOT EXISTS `ocenter_member` (
  ...
  `name` char(32) NOT NULL DEFAULT '' COMMENT '昵称',
...
(1000, '整站标题', '', '', '', 1, '', '', '', 7, '-'),
(1001, '用户中心', 'Ucenter', 'index', 'index', 1, '{$user_info.username|text}的个人主页', '{$user_info.username|text}的个人主页', '{$user_info.name|op_t}的个人主页', 3, '-'),
